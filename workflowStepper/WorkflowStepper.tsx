...
import { WorkflowStepperProps, StepData } from './types';
...
export const WorkflowStepper: React.FC<WorkflowStepperProps> = ({
  ...
  useEffect(() => {
    if (!validateStepIds(steps)) {
      console.warn('WorkflowStepper: Duplicate step IDs detected. Each step must have a unique ID.');
    }
  }, [steps]);
  ...
  const containerClasses = mergeStyles(
    styles.container,
    className
  );
