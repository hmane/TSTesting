...
export const ConflictNotificationBar: React.FC<ConflictNotificationBarProps> = ({
  ...
  if (conflictInfo?.hasConflict) {
    const conflictMessage = customMessage || 
      `This record was modified by ${conflictInfo.lastModifiedBy} on ${formatDateTime(conflictInfo.lastModified)}. Your changes might overwrite their updates.`;
