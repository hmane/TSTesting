...
import { CustomColors, StepperStyleProps, StepStatus } from './types';
...
export const getDefaultStepColors = (theme: ITheme) => {
  return {
    ...
    blocked: {
      ...
      selectedBackground: theme.palette.orange,
      text: theme.palette.white,
      selectedText: theme.palette.white,
      border: theme.palette.orange,
    },
  };
};
...
export const getStepItemStyles = (
  ...
  const borderColor = isSelected
    ? 'selectedBorder' in colorConfig
      ? colorConfig.selectedBorder || colorConfig.border
      : colorConfig.border
    : colorConfig.border;
