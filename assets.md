...
| **First batch** | **Tier 0** — pre-writing strokes (89), alphabet picture vocab A–Z (234), mascots (30), speech bubbles (14) = ~367 SVGs |
...
> **Why this matters:** A guide character massively increases kid engagement ("Follow Fox!", "Help Bunny!"). Inclusive representation is not optional — families and teachers expect to see themselves. This set provides modular, diverse characters that appear across every worksheet type.
...
| ------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Tracing**        | 1 (Letters), 2 (Numbers), 3 (Shapes), **21 (Pre-Writing Strokes)**, **22 (Alphabet Vocab — letter-to-picture)**                                                         |
...
| **Counting**       | 4, 7, 8, 11, 14, **23 (Color-Safe — countable items)**                                                                                                                  |
| **Pattern**        | 3 (Shapes), 7 (Food), 4 (Animals), **23 (Color-Safe — color sequences)**                                                                                                |
| **Sequence**       | 2 (Numbers), 4 (Animals lifecycle), 5 (Planets order), 9 (Seasons), **24 (Routines — daily sequence)**                                                                  |
| **Maze**           | 19 (Maze Elements), 20 (Decorative), **28.3 (Themed Collectibles)**                                                                                                     |
| **Sorting**        | 4, 7, 8, 9, 10, 11, 13, **23 (Color-Safe — sort by color)**, **24 (Routines — categorize)**, **27.2 (Sorting Mats)**                                                    |
...
| **All Generators** | 6 (Festivals — themed overlays), 20 (Decorative — borders, UI, stickers), **25 (Kid Characters & Mascots — guide characters)**, **26 (Micro-Scenes — page chrome)**     |
...
│   │   ├── mascots/           # Starry, Rosie, Blaze (10 poses each)
...
- **Animal mascots** (Section 25.4) — Starry, Rosie, Blaze x 10 poses — **30 SVGs**
...
- Number counting aids (dot arrangements, tally, ten-frame) — 82 SVGs
...
- Must be recognizable at 24x24px (`--tiny` variant) — test readability at small sizes
...
| **Tier 0** | The highest-priority batch of assets (~367 SVGs) that should be produced first — pre-writing strokes, A–Z picture vocab, mascots, speech bubbles |
